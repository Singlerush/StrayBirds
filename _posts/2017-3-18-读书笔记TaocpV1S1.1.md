...
###欧几里得算法
<br>
计算方法可以定义为一个四元组（Q,I,<img src="http://www.sciweavers.org/tex2img.php?eq=%20%5COmega%20&bc=Transparent&fc=White&im=png&fs=12&ff=arev&edit=0" align="center" border="0" alt=" \Omega " width="17" height="15" />,f)。
####四元组表示
f((m,n))=(m,n,0,1)<br>
